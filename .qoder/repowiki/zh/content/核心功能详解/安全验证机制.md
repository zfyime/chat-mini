...
## 前端认证流程集成
`ChatRoot.tsx`组件实现了完整的认证流程集成，包括密码管理、签名生成和错误处理。
...
**Section sources**
- [ChatRoot.tsx](file://src/components/ChatRoot.tsx#L1-L391)
...
export const CONFIG = {
  ...
  // 对话相关
  CONTEXT_WINDOW_SIZE: 9, // 传给OpenAI API的最大上下文条数
  HISTORY_LIST_LIMIT: 25,  // 保留的历史会话数量
